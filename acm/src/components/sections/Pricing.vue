    ...
    <div class="section-inner">
      ...
      <div class="price-grid">
        <div v-for="cat in priceCategories" :key="cat.name" class="price-card">
          ...
          <ul class="price-list">
            <li v-for="opt in cat.options" :key="opt.label" class="price-row">
              <div class="price-row-main">
                <span class="price-label">{{ opt.label }}</span>
                <span class="price-value">{{ opt.price }}</span>
              </div>
              <p v-if="opt.note" class="price-note">{{ opt.note }}</p>
            </li>
          </ul>
        </div>
      </div>
      ...
      <div class="notes-block">
        ...
        <ol class="notes-list">
          <li v-for="(note, i) in commissionNotes" :key="i" class="notes-item">
            {{ note }}
          </li>
        </ol>
      </div>

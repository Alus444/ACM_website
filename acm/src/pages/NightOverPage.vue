...
const searchIndex: SearchEntry[] = [
  ...
  },
  {
    ...
    headingId: 'git-start',
    title: 'Git記録を始める',
    text: 'Git連携 インストール PC 見つからない 表示されない 作品ごと 準備 履歴データ 記録 履歴 中央ペイン コマンド不要',
  },
  {
    page: 'git',
    headingId: 'git-dirty',
  ...
  },
  {
    ...
    headingId: 'git-start',
    title: 'Git 連携',
    text: '有効 初期値 オン 記録 履歴 ボタン 表示 非表示 プロジェクト 作品ごと 準備 無効 削除しない 記録済み履歴',
  },
  {
    page: 'linking',
        ...
        <article>
          ...
          <section v-if="activePage === 'data-files'" id="data-files" class="doc-section">
            ...
            <ul>
              ...
              <li>作品の変更履歴を保存している場合は、履歴も含めるため隠し項目を除外しないでください。</li>
...
漢字|《ルビ》</code></pre>
          ...
          <section v-if="activePage === 'git'" id="git" class="doc-section">
            ...
            <ol>
              ...
              <li>プロジェクト画面下部のGit操作から、この作品で記録を始めるための準備を行います。</li>
